...
const Strings_fr = {
    ...
    ComponentBar: {
        ...
        SectionNames: {
            InputOutput: ["Entrées/sorties", "Entrées/ sorties"],
            Gates: ["Portes"],
            Layout: ["Disposition", "Dispo- sition"],
            Arithmetic: ["Arithmétique", "Arith- métique"],
            Combinational: ["Combinatoire", "Combina- toire"],
            Memory: ["Mémoire"],
            Custom: ["Personnalisé", "Person- nalisé"],
        },
    ...
    Settings: {
        ...
        hideTooltips: tuple("Désactiver les tooltips", "Si coché, les informations supplémentaires des tooltips (comme les tables de vérité) ne seront pas affichées."),
    ...
    KeyInfoPanel: {
        TestsDefined: {
            true: "Tests définis",
            false: "Aucun test défini pour ce circuit",
            info: "Si aucun test n'est défini pour ce circuit, il ne pourra pas être validé automatiquement.",
        },
        KeyMarked: {
            true: "Solution marquée",
...
const Strings_en: Strings = {
    ...
    ComponentBar: {
        SectionNames: {
            ...
            Gates: ["Gates"],
            Layout: ["Layout"],
            Arithmetic: ["Arithmetic", "Arith- metic"],
            Combinational: ["Combinational", "Combina- tional"],
            Memory: ["Memory"],
            Custom: ["Custom"],
        },
        Labels: {
    ...
    KeyInfoPanel: {
        TestsDefined: {
            true: "Tests defined",
            false: "No tests defined for this circuit",
            info: "If no tests are defined for this circuit, it cannot be automatically validated.",
        },
        KeyMarked: {
            true: "Solution marked",
